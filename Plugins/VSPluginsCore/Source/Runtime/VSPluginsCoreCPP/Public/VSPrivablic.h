...
#define VS_DECLARE_PRIVABLIC_MEMBER(CLASS, MEMBER, TYPE)	\
	...
	template struct FVSPrivablic::FPrivateMember<FVSPrivablic_Member_##CLASS##_##MEMBER, &CLASS::MEMBER>;
...
#define VS_DECLARE_PRIVABLIC_MEMBER_STATIC(CLASS, MEMBER, TYPE)	\
	...
	template struct FVSPrivablic::FPrivateMember<FVSPrivablic_Member_Staitc_##CLASS##_##MEMBER, &CLASS::MEMBER>;
...
#define VS_DECLARE_PRIVABLIC_MEMBER_ADDRESS(CLASS, MEMBER, TYPE) \
    ...
    template struct FVSPrivablic::FPrivateMember<FVSPrivablic_Member_Address_##CLASS##_##MEMBER, &CLASS::MEMBER>;
...
#define VS_DECLARE_PRIVABLIC_METHOD(CLASS, METHOD, RETURN_TYPE, ...)	\
	...
	template struct FVSPrivablic::FPrivateMethod<FVSPrivablic_Method_##CLASS##_##METHOD, &CLASS::METHOD>;
...
#define VS_DECLARE_PRIVABLIC_METHOD_CONST(CLASS, METHOD, RETURN_TYPE, ...)	\
	...
	template struct FVSPrivablic::FPrivateMethod<FVSPrivablic_Method_Const_##CLASS##_##METHOD, &CLASS::METHOD>;
...
#define VS_DECLARE_PRIVABLIC_METHOD_STATIC(CLASS, METHOD, RETURN_TYPE, ...)	\
	...
	template struct FVSPrivablic::FPrivateMethod<FVSPrivablic_Method_Static_##CLASS##_##METHOD, &CLASS::METHOD>;
...
#define VS_DECLARE_PRIVABLIC_METHOD_ADDRESS(CLASS, METHOD, RETURN_TYPE, ...) \
    ...
    template struct FVSPrivablic::FPrivateMethod<FVSPrivablic_Method_Address_##CLASS##_##METHOD, &CLASS::METHOD>;


#define VS_PRIVABLIC_MEMBER(OBJECT, CLASS, MEMBER)	\
	((OBJECT)->*FVSPrivablic::FMember<FVSPrivablic_Member_##CLASS##_##MEMBER>::Value)

#define VS_PRIVABLIC_MEMBER_STATIC(CLASS, MEMBER)	\
	(*FVSPrivablic::FMember<FVSPrivablic_Member_Staitc_##CLASS##_##MEMBER>::Value)

#define VS_PRIVABLIC_MEMBER_ADDRESS(CLASS, MEMBER) \
    FVSPrivablic::FMember<FVSPrivablic_Member_Address_##CLASS##_##MEMBER>::Value

#define VS_PRIVABLIC_METHOD(OBJECT, CLASS, METHOD)	\
	((OBJECT)->*FVSPrivablic::FMethod<FVSPrivablic_Method_##CLASS##_##METHOD>::Ptr)

#define VS_PRIVABLIC_METHOD_CONST(OBJECT, CLASS, METHOD)	\
	((OBJECT)->*FVSPrivablic::FMethod<FVSPrivablic_Method_Const_##CLASS##_##METHOD>::Ptr)

#define VS_PRIVABLIC_METHOD_STATIC(CLASS, METHOD)	\
	(*FVSPrivablic::FMethod<FVSPrivablic_Method_Static_##CLASS##_##METHOD>::Ptr)

#define VS_PRIVABLIC_METHOD_ADDRESS(CLASS, METHOD) \
	FVSPrivablic::FMethod<FVSPrivablic_Method_Address_##CLASS##_##METHOD>::Ptr

namespace FVSPrivablic
{
