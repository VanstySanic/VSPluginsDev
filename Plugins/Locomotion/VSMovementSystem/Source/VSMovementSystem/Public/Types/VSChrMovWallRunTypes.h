...
struct FVSWallRunSettings : public FTableRowBase
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	FVector WallTraceOffset = FVector(128.0, 64.0, 128.0);
