 ...
 * 
 */
UCLASS(DisplayName = "Feature.Camera.ModifyTransform")
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Transform", meta = (EditCondition = "ModifyTransformType == EVSCameraRelatedTransformType::Custom", EditConditionHides))
