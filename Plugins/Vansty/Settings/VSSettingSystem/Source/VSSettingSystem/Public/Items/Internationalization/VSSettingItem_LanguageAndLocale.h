...
#include "VSSettingItem_LanguageAndLocale.generated.h"

/**
 * Includes language and locale.
 */
UCLASS(DisplayName = "Settings.Item.Internationalization.LanguageAndLocale")
class VSSETTINGSYSTEM_API UVSSettingItem_LanguageAndLocale : public UVSSettingItemBase_String
{
...
public:
	...
	void SetLanguageAndLocale(const FString& InCulture);

	UFUNCTION(BlueprintCallable, Category = "Settings")
	FString GetLanguageAndLocale(EVSSettingItemValueSource::Type ValueSource = EVSSettingItemValueSource::Settings) const;
