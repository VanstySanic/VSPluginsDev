...
public:
	...
	void BindWidget(UWidget* Widget, FName TypeName);
	
	/** This is possibly unused. */
	UFUNCTION(BlueprintCallable, Category = "Widget")
	void UnbindWidget(UWidget* Widget, FName TypeName);

	UFUNCTION(BlueprintCallable, Category = "Widget")
	bool IsWidgetBound(UWidget* Widget) const;

	UFUNCTION(BlueprintCallable, Category = "Widget")
	FName GetWidgetBoundTypeName(UWidget* Widget) const;

	/** Unbind the widget, then bind the widget again. */
	UFUNCTION(BlueprintCallable, Category = "Widget")
	void RebindWidget(UWidget* Widget);
	
	UFUNCTION(BlueprintCallable, Category = "Widget")
	void RebindAllWidgets();

	UFUNCTION(BlueprintCallable, Category = "Widget")
	void RebindWidgetsOfType(FName TypeName);
