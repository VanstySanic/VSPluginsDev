...
// #include "VSAnimNode_OrientationWarping.generated.h"
//
// struct FAnimationInitializeContext;
// struct FComponentSpacePoseContext;
// struct FNodeDebugData;
//
// namespace VS::AnimationWarping
// {
// 	class FVSRootOffsetProvider : public UE::Anim::IGraphMessage
// 	{
// 		DECLARE_ANIMGRAPH_MESSAGE(FVSRootOffsetProvider);
//
// 	public:
//
// 		FVSRootOffsetProvider(const FTransform& InRootTransform)
...
// struct VSANIMGRAPH_API FVSAnimNode_OrientationWarping : public FAnimNode_SkeletalControlBase
// {
// 	GENERATED_BODY()
//
