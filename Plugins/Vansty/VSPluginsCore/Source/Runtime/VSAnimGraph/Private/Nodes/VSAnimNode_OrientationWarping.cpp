...
//
//
// #include "Nodes/VSAnimNode_OrientationWarping.h"
...
// }
//
// void FVSAnimNode_OrientationWarping::GatherDebugData(FNodeDebugData& DebugData)
// {
...
// }
//
// void FVSAnimNode_OrientationWarping::Initialize_AnyThread(const FAnimationInitializeContext& Context)
// {
...
// }
//
// void FVSAnimNode_OrientationWarping::UpdateInternal(const FAnimationUpdateContext& Context)
// {
...
// 	{
// 		if (VS::AnimationWarping::FVSRootOffsetProvider* RootOffsetProvider = Context.GetMessage<VS::AnimationWarping::FVSRootOffsetProvider>())
// 		{
...
// }
//
// void FVSAnimNode_OrientationWarping::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output, TArray<FBoneTransform>& OutBoneTransforms)
// {
...
// }
//
// bool FVSAnimNode_OrientationWarping::IsValidToEvaluate(const USkeleton* Skeleton, const FBoneContainer& RequiredBones)
// {
// #if ENABLE_ANIM_DEBUG
...
// }
//
// void FVSAnimNode_OrientationWarping::InitializeBoneReferences(const FBoneContainer& RequiredBones)
// {
...
// }
//
// void FVSAnimNode_OrientationWarping::Reset(const FAnimationBaseContext& Context)
// {
// 	bIsFirstUpdate = true;
