...
void UVSInteractFeatureAgent::OnFeatureDeactivated_Implementation()
{
	StopAllInspections();
...
void UVSInteractFeatureAgent::OnGameplayTagEventNotified_Implementation(const FGameplayTag& TagEvent)
{
	Super::OnGameplayTagEventNotified_Implementation(TagEvent);
