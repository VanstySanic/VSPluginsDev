...
void UVSInteractFeature::Initialize_Implementation()
{
	...
	GetGameplayTagController()->OnTagEventNotified.AddDynamic(this, &UVSInteractFeature::OnGameplayTagEventNotified);
}
...
void UVSInteractFeature::Uninitialize_Implementation()
{
	...
	{
		GameplayTagController->OnTagsUpdated.RemoveDynamic(this, &UVSInteractFeature::OnGameplayTagsUpdated);
		GameplayTagController->OnTagEventNotified.RemoveDynamic(this, &UVSInteractFeature::OnGameplayTagEventNotified);
	}
...
void UVSInteractFeature::OnGameplayTagsUpdated_Implementation()
{
	
}

void UVSInteractFeature::OnGameplayTagEventNotified_Implementation(const FGameplayTag& TagEvent)
{
